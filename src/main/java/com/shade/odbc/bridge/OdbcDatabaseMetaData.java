...
public class OdbcDatabaseMetaData implements DatabaseMetaData {
    ...
    public OdbcDatabaseMetaData(@NotNull JDBC4Connection connection) {
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern, String[] types) throws SQLException {
        ...
        OdbcException.check(OdbcLibrary.INSTANCE.SQLTablesW(
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern) throws SQLException {
        ...
        OdbcException.check(OdbcLibrary.INSTANCE.SQLColumnsW(
            statement.getHandle().getPointer(),
            catalog == null ? null : new WString(catalog), OdbcLibrary.SQL_NTS,
            schemaPattern == null ? null : new WString(schemaPattern), OdbcLibrary.SQL_NTS,
            tableNamePattern == null ? null : new WString(tableNamePattern), OdbcLibrary.SQL_NTS,
